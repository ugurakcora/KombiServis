...
export const metadata: Metadata = {
  title: "Petek Temizliği | Ordu Kombi Servisi",
  description:
    "Profesyonel petek temizliği hizmeti ile ısınma performansınızı artırın, enerji tasarrufu sağlayın.",
};
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                <p className="text-lg mb-6">
                  ...
                  için düzenli temizlik şarttır. Ordu Kombi olarak, özel
                  ekipmanlarımızla profesyonel petek temizliği hizmeti
                  sunuyoruz.
                </p>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p>
                        Özel temizlik makinesi ile peteklere basınçlı su ve
                        kimyasal çözelti verilerek içlerindeki tortu ve kireç
                        çözülür.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-2">Durulama</h3>
                      <p>
                        Temizlik sonrası, petekler temiz su ile durulanarak
                        kimyasal kalıntılar uzaklaştırılır.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-primary-50 border-l-4 border-primary-500 p-6 mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Çevre dostu temizlik kimyasalları</li>
              ...
              <div className="space-y-4 mb-8">
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <p>
                    Ortalama bir ev için petek temizliği işlemi 2-4 saat
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  <h3 className="text-xl font-semibold mb-2">
                    Petek temizliği sırasında evde olmam gerekir mi?
                  </h3>
                  <p>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  <h3 className="text-xl font-semibold mb-2">
                    Petek temizliği için en uygun zaman nedir?
                  </h3>
                  <p>
              ...
              <div className="text-center">
                <h2 className="text-2xl md:text-3xl font-bold mb-6">
                  Petek Temizliği İçin Hemen Randevu Alın
                </h2>
                <p className="mb-6">
                  Daha verimli ısınma ve enerji tasarrufu için peteklerinizin
                  temizliğini ihmal etmeyin. Ordu Kombi'nin uzman ekibiyle hemen
                  iletişime geçin.
                </p>
